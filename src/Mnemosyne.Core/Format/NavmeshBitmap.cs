...
// patched for Mnemosyne: vnavmesh took this from SharpDX.Win32, which Core does not
// reference. Same field order/sizes as the Win32 BITMAPINFOHEADER (40 bytes).

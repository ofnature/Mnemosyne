...
public record class Navmesh(int CustomizationVersion, DtNavMesh Mesh, VoxelMap? Volume)
{
	...
	public static DtNavMesh DeserializeMesh(BinaryReader reader)
	{
	...
	public static void SerializeMesh(BinaryWriter writer, DtNavMesh mesh)
	{
	...
	public static void SerializeMeshParams(BinaryWriter writer, DtNavMeshParams opt)
	{
	...
	public static VoxelMap? DeserializeVolume(BinaryReader reader)
	{
	...
	public static void SerializeVolume(BinaryWriter writer, VoxelMap? volume)
	{
		if (volume == null)
		{
